      ...
      <body style={{ margin: 0 }}>
        <div className="ge-root">
          ...
          <div className="ge-card">
            ...
            <div className="ge-mark" aria-hidden="true"><span>!</span></div>
            <h1 className="ge-title">일시적인 오류가 발생했습니다</h1>
            <p className="ge-desc">잠시 후 다시 시도해 주세요. 문제가 계속되면 아래 연락처로 문의해 주시기 바랍니다.</p>
            ...
            <div className="ge-contact">
              ...
              <span className="ge-contact-val">Tel {CONTACT_TEL}<span className="ge-dot">·</span>{CONTACT_EMAIL}</span>
            </div>
          </div>
...
.ge-mark{width:66px;height:66px;margin:24px auto 0;border-radius:50%;border:2px solid #2E1A6B;
  display:flex;align-items:center;justify-content:center}
.ge-mark span{font-size:34px;font-weight:800;line-height:1;color:#2E1A6B}
