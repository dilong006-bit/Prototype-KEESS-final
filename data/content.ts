...
export const HERO = {
  ...
  h1Tail: '을,',
  h1Line2: '한 곳에서 고릅니다',
  lead: '직무·어학·IT·리더십·법정·제작까지 8,426개 과정. 조직 과제에 맞는 교육을 6개 체계에서 찾습니다.',
  note: '프로토타입 (B안 · 6축 체계형). 체계·규모는 소개서 기준, 대표 과정 34종은 실데이터. 실사 이미지는 교체 슬롯. 가격은 표시하지 않습니다.',
  core: { b: '8,426', span: '개 과정 · 6개 체계 · 매월 100+ 신규' },
  hex: [
...
export const AX5 = {
  ...
  lawSub: '공통 법정의무교육',
  laws: [
    { h3: '성희롱 예방', 근거: '남녀고용평등법 §13', 대상: '전 직원', 주기: '연 1회' },
    { h3: '직장 내 괴롭힘', 근거: '근로기준법 §76의3', 대상: '전 직원', 주기: '연 1회' },
    { h3: '장애인 인식개선', 근거: '장애인고용촉진법 §5의2', 대상: '전 직원', 주기: '연 1회' },
    { h3: '개인정보보호', 근거: '개인정보보호법 §28', 대상: '취급자', 주기: '연 1회↑' },
    { h3: '퇴직연금', 근거: '근퇴법 §32', 대상: '가입 근로자', 주기: '연 1회' },
  ],
  diffSub: '경쟁사 대비 차별화',
