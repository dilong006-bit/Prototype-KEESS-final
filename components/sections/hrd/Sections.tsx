  ...
  return (
    <form onSubmit={submit}>
      ...
      <div className="frow">
        ...
        <div className="field"><label>관심 영역</label><select id="fArea" ref={areaRef} value={v.interest} onChange={upd('interest')}>{INQ.interests.map((o) => <option key={o}>{o}</option>)}</select></div>
      </div>
